...
2. Record structural decisions and rejected alternatives before changing a published contract.
3. Update metric, report, security, test, and recovery contracts together when their behavior changes.
